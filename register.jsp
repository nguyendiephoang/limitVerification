            ...
            <form action="registerController" method="post" class="form">
                ...
                <div class="column">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" placeholder="Enter Health Insurances" name="healthInsurance" required pattern="([0-9]{15})\b" title="Must contain 15 digits"/>
                        <%
                ...
                <div class="column">
                    <div class="input-box">
                        ...
                        // Chuyển currentDateString thành đối tượng Date
                        Date currentDateObject = dateFormat.parse(currentDateString);

                        // Tạo đối tượng Calendar và thiết lập ngày hiện tại
                        Calendar calendar = Calendar.getInstance();
                        calendar.setTime(currentDateObject);

                        // Trừ đi 18 năm
                        calendar.add(Calendar.YEAR, -18);

                        // Lấy ngày tháng năm sau khi trừ
                    ...
                    <div class="input-box">
                        ...
                        <input type="date" max="<%= resultDateString%>" placeholder="Enter birth date" required name ="dob"/>
                    </div>
                </div>
